          ...
          >
            ...
            <div className="relative w-28 shrink-0 bg-background-muted sm:w-full sm:aspect-[16/10]">
              ...
              <button
                ...
                className="absolute right-1.5 top-1.5 z-10 flex size-7 items-center justify-center rounded-full bg-white/80 transition-colors hover:bg-white sm:right-2 sm:top-2 sm:size-8"
              >
                {isFavourite(restaurant.id) ? (
                  <svg viewBox="0 0 24 24" fill="currentColor" className="size-4 text-red-500 sm:size-5">
                    <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" />
                  </svg>
                ) : (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="size-4 text-foreground-muted sm:size-5">
